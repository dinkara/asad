...
interface IUserRepo extends IRepo {
    ...
    function syncRoles(array $data = [], $detach = true);

    function syncSocialNetworks(array $data = [], $detach = true);

    function detachRole(Role $model);

    function detachSocialNetwork(SocialNetwork $model);

    function isAttachedToRole($id);

    function isAttachedToSocialNetwork($id);
