...
use App\Http\Requests\BulkUserSessionRequest;
use App\Http\Requests\BulkDeleteUserSessionRequest;
...
class UserSessionController extends ResourceController
{
    ...
    public function __construct(IUserSessionRepo $repo, UserSessionTransformer $transformer) {
        parent::__construct($repo, $transformer);


        $this->middleware('owns.usersession', ['only' => []]);
        $this->middleware('owns.usersession', ['only' => ['update', 'destroy']]);
