...
class Role extends Model
{
    ...
    public function permissions($q = null, $orderBy = null)
    {
        $relation = $this->belongsToMany('App\Models\Permission', 'roles_permissions', 'role_id', 'permission_id')
                         ->withTimestamps();
    ...
    {
        $relation = $this->belongsToMany('App\Models\User', 'users_roles', 'role_id', 'user_id')
                         ->withTimestamps();
        if($q == null && $orderBy == null){
            return $relation;
        }
